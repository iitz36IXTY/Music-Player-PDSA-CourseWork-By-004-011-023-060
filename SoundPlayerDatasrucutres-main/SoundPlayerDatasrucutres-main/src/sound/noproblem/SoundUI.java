...
import static sound.noproblem.SongData.cnt;
import static sound.noproblem.SongData.playlist;
import static sound.noproblem.SongData.songMap;
...
//        list.songList[3].currentPath = Paths.get(".").toAbsolutePath().normalize().toString();
    ...
    private void initComponents() {
        ...
        favouriteScreen = new javax.swing.JList<>();
        ...
        PlayingButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        shuffleButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sound/New Folder/shuffle.png"))); // NOI18N
        shuffleButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        SettingLayout.setHorizontalGroup(
            ...
            .addGroup(SettingLayout.createSequentialGroup()
                ...
                .addGap(80, 80, 80)
                .addComponent(shuffleButton, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(SettingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(SettingLayout.createSequentialGroup()
                        .addGroup(SettingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(shuffleButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(2, 2, 2))
                    .addComponent(PauseButton)
                    .addComponent(PlayingButton)
                    .addComponent(previousButton)
        ...
        Deleting.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        MoveUpButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        MoveDownButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        SearchingName.setEnabled(false);
        ...
        SearchingSinger.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        Beginning.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jScrollPane7.setViewportView(favouriteScreen);
                        ...
                        .addGroup(ListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ListLayout.createSequentialGroup()
                                ...
                                .addGroup(ListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(favouriteButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(ListLayout.createSequentialGroup()
                        .addGroup(ListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void PlayingButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayingButtonMouseClicked
        ...
        String abs = playlistScreen.getSelectedValue();
        try{
        Playstat.setText("Playing: ");
            if (playlistScreen.getSelectedIndex()==playlistScreen.getSelectedIndex()) {
                SongName.setText(abs);
            }else{
        ...
        songMap.put(abs, songMap.get(abs) + 1);
   ...
   String nGet = SsingerText.getText(); 
    ...
    private void favouriteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_favouriteButtonActionPerformed
        ...
        // Sort the songs based on the play count in descending order
        List<String> mostPlayedSongs = songMap.entrySet().stream()
            .sorted((e1, e2) -> e2.getValue().compareTo(e1.getValue()))
            .map(Map.Entry::getKey)
            .collect(Collectors.toList());
    
    // Update the favourite screen ComboBox with the sorted songs
    favouriteScreen.setModel(new DefaultComboBoxModel<>(mostPlayedSongs.toArray(new String[0])));
    ...
    private javax.swing.JList<String> favouriteScreen;
